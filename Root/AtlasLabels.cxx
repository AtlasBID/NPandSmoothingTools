...
void ATLASLabelOld(Double_t x,Double_t y,const std::string &text,Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
  ...
  if (text != "") {
    ...
    p.SetTextFont(42);
    p.SetTextColor(color);
    p.DrawLatex(x+0.115,y,text.c_str());
  }
}
...
void myText(Double_t x,Double_t y, Double_t size,Color_t color,const char *text) 
{
  //Double_t tsize=0.05;
